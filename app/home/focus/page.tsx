...
export default function FocusPlaceholderPage() {
  return (
      ...
      <Card className="border-border bg-card shadow-xs w-full">
        <CardContent className="p-8 flex flex-col items-center text-center space-y-4">
          ...
          <p className="text-xs text-muted-foreground max-w-sm leading-relaxed">
            Mode fokus minim distraksi dengan timer pengerjaan, detail subtask, dan alasan rekomendasi prioritas akan hadir di Phase 4.
          </p>
